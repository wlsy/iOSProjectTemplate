...
mkdir -p "$installDirectory"/"iOS Application.xctemplate/Macro/"
...
mkdir -p "$installDirectory"/"iOS Application.xctemplate/Storyboards/"
...
mkdir -p "$installDirectory"/"iOS Application.xctemplate/Helpers/"
